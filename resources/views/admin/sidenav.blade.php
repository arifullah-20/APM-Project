<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item ">
                    <a href="/navbar" class="menu-link ">
                        <div data-i18n="Without menu">Navbar</div>
                    </a>
                </li>
                <li class="menu-item " >
        ...
        <script>
            // Fungsi untuk menangani klik pada menu-link
            function handleMenuClick(event) {
                // Menghapus kelas "active" dari semua elemen dengan kelas "menu-link"
                ...
                // Jika elemen yang diklik juga memiliki kelas "menu-toggle"
                if (event.currentTarget.classList.contains('menu-toggle')) {
                    // Mencari elemen "menu-item" terkait
                    var menuItem = event.currentTarget.closest('.menu-item');

                    // Menambahkan atau menghapus kelas "open" dari elemen "menu-item"
                    menuItem.classList.toggle('open');
                }
            }

            // Mengambil semua elemen dengan kelas "menu-link"
            var menuLinks = document.querySelectorAll('.menu-link');

            // Menambahkan event listener untuk setiap elemen menu-link
