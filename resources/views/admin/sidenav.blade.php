<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Layout Setting</span>
        </li>
        <li class="menu-item open" id="layoutsItem">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Layout Setting</div>
            </a>
            <ul class="menu-sub">
        ...
        <!-- Front Pages -->
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Apps &amp; Content</span>
        </li>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item" onclick="handleSubMenuItemClick(this)">
                    <a href="/partner" class="menu-link">
                        <div data-i18n="Without menu">Media Partner</div>
                    </a>
                </li>
                <li class="menu-item" onclick="handleSubMenuItemClick(this)">
                ...
                <li class="menu-item" onclick="handleSubMenuItemClick(this)">
                    <a href="/media-sosial" class="menu-link">
                        <div data-i18n="Without menu">Why APM</div>
                    </a>
                </li>
            </ul>
        </li>
